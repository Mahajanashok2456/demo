        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground max-w-md mb-6">
              Crafting unforgettable journeys since 2016. Your dreams, our expertise—let's explore the world together.
            </p>
            <div className="flex gap-4">
              {['instagram', 'twitter', 'facebook', 'linkedin'].map((social) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-10 h-10 rounded-full glass flex items-center justify-center text-muted-foreground hover:text-accent hover:border-accent/30 transition-all"
                >
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Home', 'Packages', 'About Us', 'Founders', 'Contact'].map((link) => (
                <li key={link}>
          ...
          {/* Packages */}
          <div>
            <h3 className="font-display font-semibold text-foreground mb-4">Packages</h3>
            <ul className="space-y-3">
              {['Adventure', 'Luxury', 'Budget', 'Family', 'Spiritual', 'International'].map((pkg) => (
                <li key={pkg}>
                  <a href="#" className="text-muted-foreground hover:text-foreground transition-colors">
                    {pkg}
                  </a>
